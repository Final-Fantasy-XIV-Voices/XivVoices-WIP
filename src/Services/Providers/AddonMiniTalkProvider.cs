...
public class AddonMiniTalkProvider(ILogger _logger, IGameInteropProvider _gameInteropProvider, IMessageDispatcher _messageDispatcher, IPlaybackService _playbackService, IFramework _framework) : PlaybackQueue(MessageSource.AddonMiniTalk, _logger, _framework, _playbackService, _messageDispatcher), IAddonMiniTalkProvider
{
