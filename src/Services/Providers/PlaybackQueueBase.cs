...
public abstract class PlaybackQueue(MessageSource _messageSource, ILogger _logger, IFramework _framework, IPlaybackService _playbackService, IMessageDispatcher _messageDispatcher)
{
