...
public partial class GameInteropService(IClientState _clientState, IObjectTable _objectTable, IFramework _framework, ICondition _condition) : IGameInteropService
{
